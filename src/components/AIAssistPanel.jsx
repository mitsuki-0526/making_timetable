...
const AIAssistPanel = ({ onClose }) => {
  const { teachers, structure, timetable, settings, subject_constraints, setGeneratedTimetable } = useTimetableStore();
  const [activeTab, setActiveTab] = useState('review'); // 'review' | 'generate'
